...
//     setCurrentState('fido-seedkey-registration');
//     setError('');
//   };

//   const handleFidoSeedKeyRegistrationComplete = () => {
...
//       setCurrentState('registration-details');
//     } else if (currentState === 'fido-seedkey-registration') {
//       setCurrentState('device-verification');
...
//     case 'fido-seedkey-registration':
//       return (
//         <FidoSeedKeyRegistration
//           onBack={handleBack}
//           onProceed={handleFidoSeedKeyRegistrationComplete}
//           phoneNumber={phoneNumber}
//           customerId={customerId}
//         />
//       );
